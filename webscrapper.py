...
def login(day:int):
    """ 
        ...
        Login method will take in the day number which is an integer which will be concatenated to the url to retrieve the associated data
